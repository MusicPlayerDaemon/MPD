...
public:
	FlacEncoder(AudioFormat _audio_format, FLAC__StreamEncoder *_fse, unsigned _compression, bool _chaining);
...
PreparedFlacEncoder::PreparedFlacEncoder(const ConfigBlock &block)
	...
	chaining(block.GetBlockValue("oggchaining",false))
{
}
...
FlacEncoder::FlacEncoder(AudioFormat _audio_format, FLAC__StreamEncoder *_fse, unsigned _compression, bool _chaining)
	:Encoder(_chaining),
...
PreparedFlacEncoder::Open(AudioFormat &audio_format)
{
	...
	return new FlacEncoder(audio_format, fse, compression, chaining);
}
