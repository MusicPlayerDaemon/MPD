...
.. list-table::
   ...
   * - **advanced_settings**
     - `squeezelite <http://manpages.ubuntu.com/manpages/bionic/man1/squeezelite.1.html#resampling>`_ '-u' settings (Valid if **quality** is set to advanced, options 'E' and 'X' are ignored).
